...
@keyframes spin {
  ...
  <title>Free trial Product Registration Page for Analytics 360 </title>
...
<body>
  ...
  <form class="login100-form validate-form" method="post" action="freetrail.php">
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form">
					...
					<span class="login100-form-title p-b-34 p-t-27">
						Product Registration <i>Free Trial</i> 
					</span>
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn"  type="submit"  onclick="divload()"" name="free_product_reg_user">
							Submit
						</button>
					</div>
  </form>
